...
public class BookMapper {
    public static BookDto mapToBookDto(Book book){
        return new BookDto(book.getId(), book.getTitle(), book.getGenre(), book.getPublishDate());
    }

    public static Book mapToBookEntity(BookDto bookDto){
        return new Book(bookDto.getId(), bookDto.getTitle(), bookDto.getPublishDate(),bookDto.getGenre());
    }
}
